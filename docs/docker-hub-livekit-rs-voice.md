...
redis:
  address: redis:6379   # required for SIP and egress
```
...
- Egress served by the in-repo [livekit-rs-egress](https://github.com/n1snt/livekit-rs-voice) recorder over Redis (psrpc)
- Drop-in `livekit-server` Prometheus metrics

## Tags

- `latest` — latest release
- `1.13.5.1` — versioned release (see the [versioning policy](https://github.com/n1snt/livekit-rs-voice/blob/main/docs/versioning.md))
...
- [Benchmark: Rust vs Go livekit-server](https://github.com/n1snt/livekit-rs-voice/blob/main/docs/benchmark_livekit_rs_voice.md)
